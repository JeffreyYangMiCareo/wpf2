...
//
//	  public List< String> getBuildList (String fileName)   throws Exception
//	  {
//		  
...
//	    	    String buildName= node.getAttributes().getNamedItem("Name").getNodeValue();
//	    	    empList.add( buildName ) ;
//	    	    
//		    
//		    
//		    }
...
//			          //tr.BuildOutput = cNode.getAttributes().getNamedItem("BuildOutput").getNodeValue();
//		
////			          empList.add(tr);
//		        	  
//		          }
